...
import CalendarEvents from "./dashboard/calendar/Calendar"
...
const MembersEditor = React.lazy(() => import("./groups/members/MembersEditor"))
	...
	return (
		<Suspense fallback={<Loading />}>
			<Switch>
				...
				<Route path={localRoutes.calendar} component={CalendarEvents} />
